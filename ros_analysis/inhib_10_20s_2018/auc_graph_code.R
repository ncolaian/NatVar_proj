...
#THIS WAS MODIFIED FOR the second batch
...
path_ros <- "/Users/nicholascolaianni/Documents/dangl_lab/ros_analysis/inhib_10_20s_2018/"
...
csv_list[[1]]$Name[csv_list[[1]]$Name == "236_a"] <- "236"
